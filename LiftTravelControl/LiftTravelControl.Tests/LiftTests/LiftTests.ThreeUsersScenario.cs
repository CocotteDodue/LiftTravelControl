...
namespace LiftTravelControl.Tests.LiftTests
{
    public partial class LiftTests
    {
        ...
        //Passenger 1 summons lift to go up from Ground.They choose L5.Passenger 2 summons lift to go down from L4.Passenger 3 summons lift to go down from L10.Passengers 2 goes to Ground and 3 choose to travel to L8.
        [Fact]
